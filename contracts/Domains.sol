...
contract Domains is ERC721URIStorage {
  ...
  string svgPartTwo = "</text></svg>";
    ...
    constructor(string memory _tld)
        payable
        ERC721("Falanges Namez Service", "FNS")
    {
    ...
    function register(string calldata name) public payable {
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domain on the Falanges name service", "image": "data:image/svg+xml;base64,',
        ...
        _setTokenURI(newRecordId, "ipfs://QmaUJcg1eZpKYuHZbXQqE1HkUf8Nq3E6NQaw5z31HSXeg8");
